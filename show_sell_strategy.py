...
def main() -> None:
    ...
    # Strategy exit params (for display)
    ...
    for p in positions:
        ...
        # Prefer tracker for entry; fallback to broker cost
        ...
        # Current price from market value for display (optional: could fetch quote for mid)
